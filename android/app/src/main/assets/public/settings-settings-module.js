...
module.exports = "<ion-header>\r\n  <ion-toolbar>\r\n    <ion-buttons slot=\"start\">\r\n      <ion-menu-button></ion-menu-button>\r\n    </ion-buttons>\r\n    <ion-title>\r\n      Account and Settings\r\n    </ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content>\r\n  <ion-list>\r\n    <ion-item (click)=\"accountButtonClick()\">\r\n          Account\r\n      <div class=\"item-note\" slot=\"end\">\r\n          <ion-icon name=\"contact\"></ion-icon>\r\n      </div>\r\n    </ion-item>\r\n    <ion-item (click)=\"signoutButtonClick()\">\r\n          Sign Out\r\n      <div class=\"item-note\" slot=\"end\">\r\n      <ion-icon name=\"undo\"></ion-icon>\r\n      </div>\r\n    </ion-item>\r\n        <ion-item (click)=\"aboutButtonClick()\">\r\n          About Bronco Nutrition\r\n      <div class=\"item-note\" slot=\"end\">\r\n      <ion-icon name=\"information-circle\"></ion-icon>\r\n      </div>\r\n    </ion-item>\r\n  </ion-list>\r\n  \r\n  <!--\r\n    <div *ngIf=\"selectedItem\" padding>\r\n      You navigated here from <b>{{selectedItem.title }}</b>\r\n    </div>\r\n  -->\r\n</ion-content>\r\n"
...
var SettingsPage = /** @class */ (function () {
    function SettingsPage(alertController, authService, navCtrl) {
        this.alertController = alertController;
        this.authService = authService;
        this.navCtrl = navCtrl;
    }
    SettingsPage.prototype.accountButtonClick = function () {
        this.navCtrl.navigateForward('account');
    };
    SettingsPage.prototype.signoutButtonClick = function () {
        this.displaySignoutAlert();
    };
    SettingsPage.prototype.aboutButtonClick = function () {
        this.navCtrl.navigateForward('about');
    };
    SettingsPage.prototype.ngOnInit = function () { };
    SettingsPage.prototype.displaySignoutAlert = function () {
    ...
    SettingsPage = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_0__["AlertController"],
